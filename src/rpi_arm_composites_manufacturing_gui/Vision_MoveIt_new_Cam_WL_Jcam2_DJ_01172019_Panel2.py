...
#    CamParam = CameraParams(2342.561249990927, 1209.151959040735, 2338.448312671424, 1055.254852652610, 1.0, -0.014840837133389, -0.021008029929566, 3.320024219653553e-04, -0.002187550225028, -0.025059986937316)
    ...
    loaded_object_points_ground_in_panel_system_stage_1 = loadmat('/home/wasonj/Desktop/DJ/Ideal Position/Panel2_Cam_636_object_points_ground_tag_in_panel_frame_Offset_In_Nest.mat')['object_points_ground_in_panel_tag_system']
    loaded_object_points_ground_in_panel_system_stage_2 = loadmat('/home/wasonj/Desktop/DJ/Ideal Position/Panel2_Cam_636_object_points_ground_tag_in_panel_frame_In_Nest.mat')['object_points_ground_in_panel_tag_system']    
    ...
    loaded_rvec_difference = loadmat('/home/wasonj/Desktop/DJ/Ideal Position/Panel2_Cam_636_object_points_ground_tag_in_panel_frame_Offset_In_Nest.mat')['rvec_difference']
    loaded_tvec_difference = loadmat('/home/wasonj/Desktop/DJ/Ideal Position/Panel2_Cam_636_object_points_ground_tag_in_panel_frame_Offset_In_Nest.mat')['tvec_difference']
    ...
    while ((du>3) | (dv>3) and (iteration<50)):    #try changing du and dv to lower values(number of iterations increases)
        ...
        if((du<4) and (dv<4) and (stage==1)):
			...
			filename_pose1 = "/home/wasonj/Desktop/DJ/Code/Data/Panel2_Above_Nest_Pose_"+str(t1)+".mat"
...
#            print "Average Reprojectoin error: ",np.mean(imgPoints_ground-reprojected_imagePoints_ground_2, axis=0)
            ...
            cv2.waitKey(1)
            #Save
            filename_image = "/home/wasonj/Desktop/DJ/Code/Images/Panel2_Acquisition_"+str(t1)+"_"+str(iteration)+".jpg"
...
#            f_handle.close()
    ...
    filename_data = "/home/wasonj/Desktop/YC/Data/Panel2_Data_"+str(t1)+".mat"
    ...
    filename_force_data = "/home/wasonj/Desktop/YC/Data/Panel2_Data_force_"+str(t1)+".mat"
...
#    
#    #Load ideal pose differnece information from file
#    loaded_rvec_difference = loadmat('/home/wasonj/Desktop/DJ/Ideal Position/Cam_636_object_points_ground_tag_in_panel_frame_Above_Nest.mat')['rvec_difference']
#    loaded_tvec_difference = loadmat('/home/wasonj/Desktop/DJ/Ideal Position/Cam_636_object_points_ground_tag_in_panel_frame_Above_Nest.mat')['tvec_difference']
#
#    print"============== Ideal Pose difference in hovering position"
#    print "tvec difference: ",loaded_tvec_difference
#    print "rvec differnece: ",loaded_rvec_difference
...
#    controller_commander.compute_cartesian_path_and_move(pose_target2, avoid_collisions=False)
    ...
    #Load ideal pose differnece information from file
    loaded_rvec_difference = loadmat('/home/wasonj/Desktop/DJ/Ideal Position/Panel2_Cam_636_object_points_ground_tag_in_panel_frame_In_Nest.mat')['rvec_difference']
    loaded_tvec_difference = loadmat('/home/wasonj/Desktop/DJ/Ideal Position/Panel2_Cam_636_object_points_ground_tag_in_panel_frame_In_Nest.mat')['tvec_difference']
